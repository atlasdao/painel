...
__decorate([
    (0, common_1.Get)('apitoken'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Check if user has API token' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'API token status' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "getApiTokenStatus", null);
__decorate([
    (0, common_1.Delete)('apitoken'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.HttpCode)(common_1.HttpStatus.NO_CONTENT),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Revoke API token for user' }),
    (0, swagger_1.ApiResponse)({ status: 204, description: 'API token revoked' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AuthController.prototype, "revokeApiToken", null);
__decorate([
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Reset code sent if email exists' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid request or rate limited' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Reset code verified' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Invalid code or request' }),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
