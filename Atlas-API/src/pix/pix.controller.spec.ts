...
describe('PixController', () => {
	...
	describe('createDeposit', () => {
		it('should create deposit successfully', async () => {
			...
			expect(pixService.createDeposit).toHaveBeenCalledWith('user-123', depositDto)
		})
		...
		it('should handle user ID from different JWT format', async () => {
			...
			expect(pixService.createDeposit).toHaveBeenCalledWith('user-456', depositDto)
		})
	})
	...
	describe('createWithdraw', () => {
		it('should create withdrawal successfully', async () => {
			...
			expect(pixService.createWithdraw).toHaveBeenCalledWith('user-123', withdrawDto)
		})
	})
	...
	describe('createTransfer', () => {
		it('should create transfer successfully', async () => {
			...
			expect(pixService.createTransfer).toHaveBeenCalledWith('user-123', transferDto)
		})
	})
	...
	describe('getTransactions', () => {
		it('should get user transactions', async () => {
			...
			expect(pixService.getUserTransactions).toHaveBeenCalledWith('user-123', filters)
		})
		...
		it('should get transactions without filters', async () => {
			...
			expect(result).toEqual(mockResponse)
			expect(pixService.getUserTransactions).toHaveBeenCalledWith('user-123', {})
		})
	})
	...
	describe('getTransaction', () => {
		it('should get transaction by ID', async () => {
			...
			expect(result).toEqual(mockTransaction)
			expect(pixService.getTransactionStatus).toHaveBeenCalledWith('user-123', 'trans-123')
		})
	})
	...
	describe('getTransactionStatus', () => {
		it('should get transaction status', async () => {
			...
			const result = await controller.getTransactionStatus(mockRequest, 'trans-123')
	...
	describe('generateQRCode', () => {
		it('should generate QR code', async () => {
			...
			expect(pixService.generatePixQRCode).toHaveBeenCalledWith('user-123', qrData)
		})
