...
describe('AuthService', () => {
	...
	const testDepixAddress = 'VJLCguHZDUbpy94zodwcvvUJgTxoLgjiMH8TfTwuYMUEzfMKwE2Ssu6J3LtWwtZUthoMq8HqEYhRm6Ff'
	...
	describe('register', () => {
		it('should register a new user with real DePix address', async () => {
			...
			jwtService.sign.mockReturnValueOnce('test_access_token').mockReturnValueOnce('test_refresh_token')
	...
	describe('generateApiToken', () => {
		it('should generate API token for DePix transactions', async () => {
			...
			const result = await service.generateApiToken(mockUser.id, createApiKeyDto)
		...
		it('should throw NotFoundException for non-existent user', async () => {
			...
			await expect(service.generateApiToken('invalid-id', {})).rejects.toThrow(NotFoundException)
		})
	})
