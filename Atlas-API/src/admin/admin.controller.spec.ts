...
describe('AdminController', () => {
	...
	describe('Authorization checks', () => {
		...
		it('should deny non-admin access', async () => {
			...
			await expect(controller.getAllUsers(mockRequest)).rejects.toThrow(
				ForbiddenException,
			);
	...
	describe('getUserById', () => {
		...
		it('should deny non-admin access', async () => {
			...
			await expect(
				controller.getUserById(mockRequest, 'user-456'),
	...
	describe('updateTransactionStatus', () => {
		it('should update transaction status', async () => {
			...
			adminService.updateTransactionStatus.mockResolvedValue(
				updatedTransaction,
			);
			...
			expect(adminService.updateTransactionStatus).toHaveBeenCalledWith(
				'trans-123',
	...
	describe('getAuditStats', () => {
		it('should get audit statistics', async () => {
			...
			expect(result).toEqual(mockStats);
			expect(adminService.getAuditStats).toHaveBeenCalledWith(
				undefined,
				undefined,
			);
		});
