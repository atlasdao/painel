          ...
          {step === 'success' && (
            <div className="space-y-6 text-center">
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={() => {
                    window.open('https://twitter.com/intent/tweet?text=Acabei%20de%20fazer%20uma%20doação%20para%20apoiar%20o%20projeto%20Atlas!%20💜%20Conheça%20em%20atlasdao.app', '_blank');
                  }}
