...
export function OrganizationSchema() {
  const organizationData = {
    ...
    url: 'https://atlasdao.app',
    logo: 'https://atlasdao.app/atlas-logo.jpg',
...
export function WebSiteSchema() {
  const websiteData = {
    ...
    url: 'https://atlasdao.app',
    description: 'Conta Atlas para gestao de transacoes PIX, pagamentos digitais e soberania financeira.',
    inLanguage: 'pt-BR',
    publisher: {
      '@type': 'Organization',
      name: 'Atlas DAO',
    ...
    potentialAction: {
      ...
      target: {
        '@type': 'EntryPoint',
        urlTemplate: 'https://atlasdao.app/devs?search={search_term_string}',
      },
...
export function SoftwareApplicationSchema() {
  const softwareData = {
    ...
    featureList: [
      ...
      'Central de controle completa',
      'Taxa fixa por transacao',
    ],
    screenshot: 'https://atlasdao.app/atlas-logo.jpg',
    author: {
      '@type': 'Organization',
      name: 'Atlas DAO',
    },
