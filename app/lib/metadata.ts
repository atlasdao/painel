...
// Base configuration for all Conta Atlas pages
const baseMetadata = {
...
// Default metadata for atlasdao.app
...
export const generatePageMetadata = (
  ...
  const title = `${pageTitle} - Conta Atlas`;
  const description = pageDescription || `${pageTitle} no Conta Atlas. ${baseMetadata.description}`;
